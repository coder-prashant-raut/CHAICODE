...
const Card = ({
  ...
  return (
    ...
    >
      {/* Header Section */}
<div className="flex justify-between items-center mb-3 px-5 pt-4">
  {/* Left: Course Title */}
  <h2 className="text-lg text-white font-semibold font-mono">{title}</h2>

  {/* Right: Live with red blinking dot */}
  <div className="flex items-center gap-2">
    <p className="text-red-500 text-sm font-mono font-semibold">Live</p>
    <div className="w-2.5 h-2.5 rounded-full bg-red-500 animate-blink"></div>
  </div>
</div>
      ...
      <div className="px-5 pb-5 space-y-3">
        ...
        <button className="w-full mt-2 bg-gradient-to-tr from-orange-500 to-orange-400 hover:from-orange-400 hover:to-orange-300 text-white font-semibold text-sm px-4 py-2 rounded-lg shadow-md transition duration-300">
          Enroll for {price}
        </button>
      </div>
    </motion.div>
