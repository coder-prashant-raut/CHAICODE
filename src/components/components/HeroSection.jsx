...
const HeroSection = () => {
  ...
  >
    <header
      className="relative flex flex-col justify-center items-center text-center py-16 px-4 overflow-hidden"
      role="banner"
    ...
    >
      ...
      <p className="mt-6 text-xl md:text-2xl border-b-2 border-amber-500/60 text-orange-100">
        Empower Your Coding Journey with
      </p>
  
      <h1
        id="hero-heading"
        className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight tracking-tight mt-4 text-orange-100"
      >
      ...
      <p
        className="mt-6 text-orange-200 text-base md:text-lg max-w-3xl leading-relaxed font-sans"
...
<div className="relative mt-10 font-sans">
  ...
  >
    ...
    <section
  className="w-full px-2 sm:px-0 max-w-5xl mx-auto"
  role="region"
  aria-labelledby="intro-video-title"
>
  <h2 id="intro-video-title" className="sr-only">
    ChaiCode Intro Video
  </h2>
  ...
  <div className="rounded-2xl overflow-hidden shadow-xl">
    ...
    {showToast && (
      <aside
        className="fixed bottom-16 left-1/2 transform -translate-x-1/2 w-[340px] bg-black border border-orange-400 rounded-xl p-5 shadow-2xl z-50 animate-fadeIn"
        role="alert"
        aria-live="assertive"
        aria-label="Cohort discount notification"
      >
