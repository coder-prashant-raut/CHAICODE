...
export default function StudentsCompanyShowcase() {
  return (
    ...
    role="region"
    aria-labelledby="students-placed-heading"
  >
    <div className="relative max-w-7xl py-20 px-4 overflow-hidden bg-transparent text-white w-full">
      {/* Glowing Background */}
      ...
      <div
        className="overflow-hidden w-[95%] xs:w-[80%] mx-auto py-8 relative z-10 
          [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)] 
          [mask-size:100%_100%] [mask-repeat:no-repeat]"
        aria-label="Student placement cards scrolling left to right"
      >
        <div className="flex min-w-max animate-marquee-infinite gap-6" role="list">
