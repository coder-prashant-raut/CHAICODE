...
<section className="relative px-6 py-24  text-white overflow-hidden ">
      ...
      <div className="relative z-10 pb-14 max-w-4xl mx-auto text-center">
        <motion.h2
          className="text-4xl md:text-5xl font-extrabold mb-6 py-2 bg-gradient-to-r from-fuchsia-500 via-rose-400 to-cyan-400 bg-clip-text text-transparent"
        ...
        >
          ...
          <span className="text-white font-semibold">heartfelt teaching</span> —
